...
-- ALTER TABLE class ADD `status_id` int(10) unsigned DEFAULT NULL;
-- ALTER TABLE class ADD CONSTRAINT `fk_status` FOREIGN KEY (`status_id`)  REFERENCES `status` (`id`) ON DELETE CASCADE;

-- INSERT INTO status VALUES (NULL,'not-started'), (NULL,'ongoing'), (NULL,'finished');

-- INSERT INTO class VALUES (NULL , "HTML-CSS", "2019-03-21" , "2019-04-26", 3);
-- INSERT INTO class VALUES (NULL, "Javascript1", "2019-04-03" , "2019-05-10", 3 );
-- INSERT INTO class VALUES (NULL, "Javascript2", "2019-5-17" , "2019-06-19", 3);
-- INSERT INTO class VALUES (NULL, "Javascript3", "2019-04-03" , "2019-05-10" , 3);
-- INSERT INTO class VALUES (NULL , "Database", "2019-08-11" , "2019-08-25" , 2);
-- INSERT INTO class VALUES (NULL , "React", "2019-09-1" , "2019-09-30" , 1);
